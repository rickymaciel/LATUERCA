...
namespace LaTuerca.Controllers
{
    public class ModelosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NombreModelo,Estado")] Modelo modelo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NombreModelo,Estado")] Modelo modelo)
        {
            if (ModelState.IsValid)
            {
