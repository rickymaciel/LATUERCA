...
namespace LaTuerca.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NombreMarcas,Estado")] Marcas marcas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NombreMarcas,Estado")] Marcas marcas)
        {
            if (ModelState.IsValid)
            {
